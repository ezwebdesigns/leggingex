              ...
              <div className="mt-auto pt-4 space-y-2">
                ...
                <a href={product.affiliate_link} target="_blank" rel="noopener noreferrer sponsored" className="block w-full">
                  <Button className="w-full h-14 text-base font-semibold rounded-2xl shadow-lg shadow-primary/20 flex items-center gap-2 hover:opacity-90 transition-opacity">
                    <svg viewBox="0 0 66 20" className="h-5 w-auto" fill="white">
                      <path d="M15.2 0C6.8 0 0 2.7 0 6.9c0 1.4.6 2.6 1.6 3.5.2.2.4.3.5.2.1-.1.1-.2.1-.3l.1-.7c0-.2 0-.3-.1-.4-.5-.5-.8-1.3-.8-2.2C1.4 4.3 4.6 2.1 9 2.1c2.5 0 4.8.8 4.8 2.8 0 1.2-.6 2.3-1.5 3-.2.2-.2.3-.1.6l.4 1.6c.1.2.1.4.2.4.1 0 .2 0 .4-.1 1.5-1.1 2.7-3.4 2.7-5.7 0-1.6-.8-4-2-4.7z"/>
                      <path d="M37.9 8.7c0 1.9 1 3.4 2.6 3.4 1.1 0 1.9-.7 2.3-1.5v1.1c0 .3.1.4.3.4s.3-.1.3-.4V8.6c0-2-1.2-3-3.1-3-1.6 0-3 .9-3.5 2.1-.3.7-.4 1.4-.4 2.2 0 .1 0 .2.1.3 0 0 0 .1.1.2h.3zm.9-2c.2-.7.8-1.5 2-1.5.8 0 1.5.4 1.9 1.2.3.6.3 1.3.3 2.3 0 1.1-.2 1.9-.7 2.6-.3.5-.9.9-1.6.9-1.1 0-1.9-.9-1.9-2.7V6.7z"/>
                      <path d="M47 9.8c-.3-.3-.8-.5-1.3-.5-.6 0-1.1.2-1.3.6-.1.3-.2.6-.2 1.1 0 1.1.3 2.3 1.1 3.1.6.6 1.4.9 2.2.9.5 0 .9-.1 1.3-.3.3-.1.7-.3.9-.6.1-.1.2-.1.3 0 0 0 .1.1 0 .2-.3.3-.6.6-1 .8-.5.2-1 .3-1.5.3-1.1 0-2.1-.4-2.8-1.1-.7-.7-1.1-1.7-1.1-2.9 0-.9.3-1.8.8-2.5.5-.7 1.2-1.1 2-1.1.8 0 1.5.3 1.9.9.1.1.1.2 0 .3-.1 0-.1.1-.2 0z"/>
                      <path d="M53.3 6.7c-.8 0-1.5.5-2 1.1l-.1-1.2c0-.2-.1-.3-.3-.3s-.3.1-.3.3v7.3c0 .3.1.4.3.4s.3-.1.3-.4v-3.5c0-1 .2-1.9.9-2.4.4-.4 1-.6 1.6-.6 1 0 1.5.7 1.5 2.1v3.7c0 .3.1.4.3.4s.4-.1.4-.4v-3.9c.1-2.1-1-3-2.6-3z"/>
                      <path d="M64.3 12.5c-.3 0-.4.1-.4.4v1.5c0 .3.1.4.4.4s.4-.1.4-.4v-1.5c0-.3-.1-.4-.4-.4z"/>
                      <path d="M10.8 12.6c-.5-.2-1.1-.3-1.6-.3-1.7 0-3.1.7-4.1 1.6-.1.1-.2.1-.3 0-.1-.1 0-.2.1-.3 1.1-.9 2.5-1.5 4.2-1.5.6 0 1.2.1 1.7.3.1 0 .2.1.2.2 0 0-.1.1-.2 0z"/>
                      <path d="M11.7 13.6c-.1 0-.2 0-.3.1-.7.5-1.7.9-2.7.9-1.5 0-2.9-.5-4-1.5-.1-.1-.2-.1-.2 0 0 0 0 .1.1.2 1.1 1.1 2.7 1.8 4.3 1.8 1.1 0 2.2-.3 3.1-.9.1-.1.1-.2 0-.3 0-.2-.2-.3-.3-.3z"/>
                    </svg>
                    View on Amazon

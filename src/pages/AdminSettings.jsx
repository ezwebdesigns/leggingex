...
export default function AdminSettings() {
  ...
  async function handleImageUpload(field) {
    ...
    const current = settings[field === 'logo' ? 'general' : 'seo'] || {};
    if (field === 'logo') {
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              update('sidebar', {
                ...sidebar,
                recent_articles_title: e.target.value,
              })
            }
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              update('sidebar', {
                ...sidebar,
                recent_articles_count: parseInt(e.target.value) || 3,
              })
            }
          />
        </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div>
          ...
          {columns.map((col, ci) => (
            <div key={ci} className="border rounded p-3 mb-3">
              ...
              {col.items.map((item, ii) => (
                <div key={ii} className="flex gap-2 mb-1">
                  ...
                  <button
                    ...
                    onClick={() => {
                      const next = [...columns];
                      next[ci].items = next[ci].items.filter(
                        (_, idx) => idx !== ii
                      );
                      update('menu_footer', {
                        ...menuFooter,
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              update('seo', { ...seo, meta_title: e.target.value })
            }
          />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              ref={fileInputRef}
              className="file-input file-input-bordered"
              onChange={() => handleImageUpload('og_image')}
            />
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              update('seo', { ...seo, robots_txt: e.target.value })
            }
          />
        </div>
      </div>
